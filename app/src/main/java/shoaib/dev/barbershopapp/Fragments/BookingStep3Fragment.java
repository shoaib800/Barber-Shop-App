...
import shoaib.dev.barbershopapp.Adapter.MyTimeSlotAdapter;
import shoaib.dev.barbershopapp.Common.Common;
import shoaib.dev.barbershopapp.Common.SpacesItemDecoration;
import shoaib.dev.barbershopapp.Interface.ITimeSlotLoadListener;
import shoaib.dev.barbershopapp.Interface.ITimeSlotLoadListener;
    ...
    private void init(View itemView) {
        ...
        horizontalCalendar.setCalendarListener(new HorizontalCalendarListener() {
            ...
            public void onDateSelected(Calendar date, int position) {
                ...
                {
                    Common.currentDate = date; // this code will not run again if you select new day same with date selected
                    loadAvailableTimeSlotOfBarber(Common.currentBarber.getBarberId(),
                            simpleDateFormat.format(date.getTime()));
                }
            }
