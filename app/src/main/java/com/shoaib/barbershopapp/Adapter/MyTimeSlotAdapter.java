...
public void onBindViewHolder(@NonNull final MyViewHolder myViewHolder, int i) {
        ...
        if (slot == i)// if slot == position
        {
            ...
            myViewHolder.card_time_slot.setCardBackgroundColor(context.getResources().getColor(R.color.ColorCardBackgroundFull));
        ...
        if(!timeSlotList.contains(i))
            {
                myViewHolder.setiRecyclerItemSelectedListener(new IRecyclerItemSelectedListener() {
                    ...
                    public void onItemSelectedListener(View view, int pos) {
                        ...
                        myViewHolder.card_time_slot.setCardBackgroundColor(context.getResources().getColor(R.color.ColorCardBackgroundAvailable));
